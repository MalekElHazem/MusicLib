...
<body>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mx-lg-2 active" href="categories.php">Categories</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container d-flex align-items-center justify-content-center fs-1 text-white flex-column">
        <h1 class="mt-5">Add Genre</h1>
        <form action="addgenre.php" method="post" class="bg-dark text-white p-4 rounded">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <input type="submit" value="Add Genre" class="btn btn-light">
            </div>
        </form>
    </div>
</section>
