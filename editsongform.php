...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center text-white flex-column ">
        <h1 class="mt-5">Edit Song</h1>
        <form action="editsong.php" method="post" enctype="multipart/form-data" class="bg-dark text-white p-4 rounded">
            <?php
            ...
            $song = $songCtr->getSong($_GET['id']);
            ?>
            <input type='hidden' name='id' value='<?php echo $song['id']; ?>'>
            <input type='hidden' name='existing_file' value='<?php echo htmlspecialchars($song['file']); ?>'>
            <div class="mb-3">
                <label for='title' class="form-label">Title:</label>
                <input type='text' name='title' value='<?php echo $song['title']; ?>' class="form-control">
            </div>
            <div class="mb-3">
                <label for='artist' class="form-label">Artist:</label>
                <input type='text' name='artist' value='<?php echo $song['artist']; ?>' class="form-control">
            </div>
            <div class="mb-3">
                <label for='feature' class="form-label">Feature:</label>
                <input type='text' name='feature' value='<?php echo $song['feature']; ?>' class="form-control">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <span>Current file: <?php echo $song['file']; ?></span>
            </div>
            <div class="mb-3">
                <label for='date' class="form-label">Release Date:</label>
                <input type='date' name='date' value='<?php echo $song['date']; ?>' class="form-control">
            </div>
            <div class="mb-3">
                <input type='submit' value='Edit Song' class="btn btn-light">
            </div>
        </form>
    </div>
</section>
