...
<body>
  ...
  <nav class="navbar navbar-expand-lg fixed-top bg-dark">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mx-lg-2 active" href="categories.php">Genres</a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="hero-section">
        ...
        <table class="table mt-5 add">
            ...
            <tbody>
                ...
                foreach ($Genres as $Genre) {
                    ...
                    echo "<td>";
                    echo "<a href='editgenreform.php?id=" . $Genre['id'] . "' class='btn btn-primary'>Edit</a>";
                    echo "<a href='deletegenre.php?id=" . $Genre['id'] . "' class='btn btn-danger'>Delete</a>";
                    echo "</td>";
                    echo "</tr>";
                }
                ?>
        ...
        <a href="addgenreform.php" class="btn btn-success mt-5 mb-5">Add</a>
        </div>
    </section>
    <!-- End Hero Section -->
